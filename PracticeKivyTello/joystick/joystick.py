...
class Joystick(Widget):
    ...
    outer_size = NumericProperty(1)  # outer ring of controller
    inner_size = NumericProperty(0.75)  # middle ring of controller
    pad_size = NumericProperty(0.5)  # inner ring of controller
    ...
    outer_background_color = ListProperty([0, 0, 255, 0.75]) # outer ring of controller
    inner_background_color = ListProperty([255, 255, 0, 0.75])  # middle ring of controller
    pad_background_color = ListProperty([0, 255, 0, 0.75])  # inner ring of controller
    """Background colors for the joystick base & pad"""

    outer_line_color = ListProperty([0.25, 0.25, 0.25, 1])  # outer line of ring of controller
    inner_line_color = ListProperty([0.7, 0.7, 0.7, 1])  # middle line of ring of controller
    pad_line_color = ListProperty([0.35, 0.35, 0.35, 1])  # inner line of ring of controller
    """Border colors for the joystick base & pad"""

    outer_line_width = NumericProperty(0.01)  # outer line width of ring of controller
    inner_line_width = NumericProperty(0.01)  # middle line width of ring of controller
    pad_line_width = NumericProperty(0.01)   # inner line width of ring of controller
    ...
    """Distance of the pad, between 0.0 & 1.0, from the center of the joystick."""
    ...
    """Position of the pad in radians, between 0.0 & 6.283, in relation to the x-axis."""
