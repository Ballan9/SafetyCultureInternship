"""
tellopy sample using joystick and video player

 - you can use PS3/PS4/XONE joystick to control DJI Tello with tellopy module
        ...
        while 1:
            ...
            for e in pygame.event.get():
                if e.type == pygame.locals.JOYAXISMOTION:
                    ...
                    if -buttons.DEAD_ZONE <= e.value and e.value <= buttons.DEADZONE:
                        e.value = 0.0
